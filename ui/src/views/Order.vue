  ...
  <div>
    <el-card class="Ktable-container">
      <Ktable isExpand :columns="columns" :operations="operations" :params="params" :getList="getOrderList"
        :searchFormColumns="searchFormColumns" :customBtn="customBtn" :expandHeader="expandHeader"
        :expandColumns="expandColumns" :products="products"></Ktable>
    </el-card>
  </div>
</template>
<script setup>
...
import { departmentDict } from '../request/dict'
